          ...
          {showAddCart && (
            <div className="flex items-center justify-between">
              <button
                ...
                className="w-max ring-1 ring-lama text-lama py-2 px-4 text-xs hover:bg-lama hover:text-white disabled:cursor-not-allowed disabled:bg-pink-200 disabled:text-white"
              >
                Thêm vào giỏ
              </button>
              <div className="text-sm text-gray-500">
                {product?.stock == 0 ? 'Hết hàng' : `Số lượng: ` + product?.stock}
              </div>
            </div>
          )}
        </div>
